          ...
          <div className="rounded-xl shadow-lg p-4 md:p-8 glow-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a 
                ...
                className="flex flex-col items-center justify-center p-3 md:p-6 bg-black/70 border border-primary-500/30 rounded-lg hover:border-primary/50 hover:shadow-lg transition-all text-center group glow-card"
              >
                ...
                <h3 className="font-heading font-semibold mb-1 text-primary-200">Discord</h3>
              ...
              >
                ...
                <h3 className="font-heading font-semibold mb-1 text-primary-200">Contact Us</h3>
            ...
            <div className="mt-10 text-center">
              ...
              >
                <span className="text-primary-100 font-medium text-sm md:text-lg">CLICK HERE TO GET 50% OFF OF YOUR SHIPPING</span>
              </a>
            </div>
          </div>
        </div>
