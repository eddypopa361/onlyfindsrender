    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} <img src="/images/onlyfinds.png" alt="ONLYFINDS" loading="lazy" className="h-8 inline-block mx-1 object-contain" /> All rights reserved.</p>
          <p className="mt-2 text-sm">
            Designed & Developed by <a href="https://carlos.sapphiresociety.ro/" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 font-medium transition-colors">CARLOS</a>
          </p>
          <p className="mt-4 text-sm max-w-4xl mx-auto">
            ONLYFINDS does not sell any physical products and neither do the agents provided. This website is purely a catalog of links to Taobao, Weidian, and other shopping sites to better educate buyers and help them avoid scams. ONLYFINDS is not affiliated with Weidian.com, Taobao.com, 1688.com, tmall.com, or any other shopping platform ('platforms'). This is not an official offer from those platforms. All links on this site are affiliate links, including price tag buttons, -tagged links, and links embedded in images. We do not earn a commission from the sale of any products, but rather from the function of acting as a freight forwarder. We are not an online store and do not sell any products.
          </p>
        </div>
      </div>
    </footer>
