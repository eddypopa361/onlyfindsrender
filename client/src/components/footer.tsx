    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} <img src="/images/onlyfinds_logo.png" alt="ONLYFINDS" loading="lazy" className="h-8 inline-block mx-1 object-contain" /> All rights reserved.</p>
