...
export default function MainNav() {
  ...
  return (
    <header className="sticky top-0 bg-black shadow-lg shadow-primary-600/20 z-40 border-b border-primary-600/20">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black border-t border-primary-600/20">
